...
$THINKUP_CFG['app_title_prefix']                 = "${entity.appTitlePrefix}";
...
// TODO Allow full timezone configuration.
...
$THINKUP_CFG['db_host']                   = '${entity.databaseHostname}';
$THINKUP_CFG['db_type']                   = 'mysql';
$THINKUP_CFG['db_user']                   = '${entity.databaseUserName}';
$THINKUP_CFG['db_password']               = '${entity.databasePassword}';
$THINKUP_CFG['db_name']                   = '${entity.databaseName}';
...
|| (getenv("MODE")=="TESTS" && ! getenv("RD_MODE")=="1")) {
    ...
    //    $THINKUP_CFG['db_password']               = 'password';
